...
.home-mark img { width: 38px; height: 38px; object-fit: contain; }
...
.transfer-summary small { grid-column:2; grid-row:1 / span 2; color: var(--text-3, #98a2b3); font-size: 10px; white-space: nowrap; }
...
@media (max-width: 720px) {
  ...
  .transfer-summary .transfer-speed { display: none; }
